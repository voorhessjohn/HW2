...
# And use this opportunity to make sure you understand these steps if you think going slowly and carefully writing out steps for a simpler data transaction will help build your understanding!
# You can assume that a user will give you the type of input/response you expect; you do not need to handle errors or user confusion. (e.g. if your form asks for a name, you can assume a user will type a reasonable name; if your form asks for a number, you can assume a user will type a reasonable number; if your form asks the user to select a checkbox, you can assume they will do so.)
